...
export default function HomePage() {
  ...
  return (
    <>
      ...
      >
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-lime-400/[0.05] rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="relative z-20 max-w-[1550px] mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 relative z-20">
            ...
            >
              <span className="font-mono text-[10px] uppercase tracking-widest text-lime-400 flex items-center gap-2">
                <span className="w-1.5 h-1.5 bg-lime-400 rounded-full animate-pulse-fast inline-block" />
              ...
              <div className="absolute bottom-6 left-6 z-20 pointer-events-none">
                <div className="glass px-6 py-4 rounded-xl flex items-center gap-4 animate-float">
                  ...
                  <div>
                    ...
                    <div className="text-lime-400 font-mono text-[10px] tracking-widest mt-1">STATUS: OPTIMAL</div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-[1550px] mx-auto px-6">
          <AnimatedSection className="mb-16">
            <h2 className="text-[3rem] md:text-[5rem] font-heading font-bold leading-none tracking-tighter mb-4">
              CAPABILITIES_<br/><span className="text-lime-400 italic">GRID</span>
            </h2>
            ...
            {services.map((svc, i) => (
              ...
              >
                <div className={`w-full h-full rounded-[2.5rem] border overflow-hidden relative transition-all duration-500 hover:scale-[1.01] hover:shadow-2xl ${
                  svc.accent 
                    ? 'bg-lime-400 border-lime-400 text-black hover:shadow-lime-400/20' 
                    : 'bg-white/[0.02] border-white/10 text-white hover:border-lime-400/40 hover:bg-white/[0.04]'
                }`}>
                  ...
                  <div className="absolute inset-0 p-8 flex flex-col justify-between z-10 w-full h-full">
                    <div className="flex justify-between items-start">
                      <div className={`w-14 h-14 rounded-2xl flex items-center justify-center shadow-lg ${
                        svc.accent ? 'bg-black text-lime-400' : 'bg-white/5 text-lime-400 border border-white/10 group-hover:bg-lime-400 group-hover:text-black transition-colors'
                      }`}>
                        <svc.icon className="w-6 h-6" />
                      </div>
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center border transition-all ${
                        svc.accent ? 'border-black/20 text-black group-hover:bg-black group-hover:text-lime-400' : 'border-white/10 text-white/50 group-hover:border-lime-400 group-hover:text-lime-400 group-hover:-rotate-45'
                      }`}>
          ...
          <div>
            <AnimatedSection>
              ...
              <h2 className="text-5xl md:text-7xl font-heading font-black tracking-tighter leading-[0.9] mb-12">
                HOW WE BUILD <br/><span className="italic font-light">SYSTEMS</span>
              </h2>
