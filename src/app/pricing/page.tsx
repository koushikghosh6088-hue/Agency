  ...
  return (
    <>
        ...
        <div className="max-w-[1550px] mx-auto px-6 relative z-10 w-full text-center">
          <AnimatedSection>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 mb-8">
              ...
              <span className="text-[0.65rem] font-mono uppercase tracking-widest text-[#ccff00]">Transparent Pricing</span>
            </div>
            <h1 className="text-[4rem] md:text-[6.5rem] lg:text-[8rem] font-heading font-black leading-[0.85] tracking-tighter mb-8 text-white uppercase">
              SIMPLE <br/><span className="italic text-[#0066ff]">HONEST PRICING</span>
            </h1>
      ...
      <section className="py-24 bg-black relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(0,102,255,0.08)_0%,transparent_60%)] pointer-events-none" />
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <AnimatedSection>
            <h2 className="text-[3rem] md:text-[5rem] font-heading font-black uppercase tracking-tighter mb-8 text-white">
              NOT SURE WHICH <span className="italic text-[#0066ff]">PLAN</span> IS RIGHT?
            </h2>
            <p className="text-white/50 font-mono text-[0.7rem] uppercase tracking-[0.25em] mb-12 leading-relaxed">
              Book a free 30-minute call. We&apos;ll tell you exactly what your business needs — no pressure, no commitment.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link href="/contact" className="group px-10 py-5 rounded-2xl text-[0.85rem] font-heading font-black uppercase tracking-[0.12em] bg-[#ccff00] text-black shadow-[0_0_30px_rgba(204,255,0,0.3)] hover:scale-[1.05] transition-all duration-300 flex items-center justify-center gap-3">
