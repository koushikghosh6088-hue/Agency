    ...
    <section className="relative py-20 md:py-28 bg-black overflow-hidden z-10">
      ...
      <div className="max-w-[1550px] mx-auto px-6 relative z-10">
        <AnimatedSection className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#0066ff]/10 border border-[#0066ff]/20 mb-6">
            <Globe className="w-3.5 h-3.5 text-[#0066ff]" />
            <span className="font-mono text-xs uppercase tracking-widest text-[#0066ff]">Industries We Serve</span>
          </div>
          <h2 className="text-[2.2rem] md:text-[3.2rem] lg:text-[4rem] font-heading font-black leading-[0.85] tracking-tighter uppercase mb-6 text-white">
            WE&apos;VE BUILT FOR <span className="italic text-[#0066ff]">EVERY INDUSTRY</span>
          </h2>
