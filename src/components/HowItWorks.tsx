      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        ...
        <AnimatedSection className="text-center mb-20">
          ...
          <h2 className="text-[2.2rem] md:text-[3.3rem] font-heading font-black uppercase tracking-tighter text-white mb-6 leading-[1]">
            ...
            <span className="italic text-[#0066ff]">3 SIMPLE STEPS</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] h-64 bg-[#0066ff]/5 blur-[120px] rounded-full pointer-events-none -z-10 animate-pulse" />
          ...
          {steps.map((step, i) => (
            <AnimatedSection key={i} delay={i * 0.1}>
              <div className="relative group p-8 lg:p-10 glass-premium rounded-[3rem] border-white/5 hover:border-white/20 transition-all duration-700 z-10 shimmer-border overflow-hidden flex flex-col items-center text-center">
                ...
                {/* Number Background */}
                <div className="absolute -top-4 -right-2 text-[120px] font-heading font-black text-white/[0.02] pointer-events-none group-hover:text-[#0066ff]/5 transition-all duration-700 group-hover:-translate-x-4">
                  {step.num}
                </div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 mb-8 group-hover:border-[#0066ff]/30 transition-colors">
                  ...
                  <div className="flex items-center gap-2 text-[#0066ff] font-heading font-black text-xs uppercase tracking-[0.2em] opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-500">
                    <span className="text-glow">Protocol Optimized</span> <CheckCircle className="w-4 h-4 shadow-[0_0_10px_#0066ff]" />
                  </div>
                </div>
              </div>
            </AnimatedSection>
        ...
        <AnimatedSection className="mt-20 text-center">
           <Link 
              href="#booking"
              className="inline-flex items-center gap-3 px-10 py-5 bg-[#0066ff] text-black font-heading font-black text-sm uppercase tracking-widest rounded-2xl hover:bg-white transition-all shadow-[0_15px_30px_rgba(0,102,255,0.2)]"
           >
