      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end mb-32">
          <div>
            ...
            <h3 className="text-5xl md:text-7xl font-heading font-bold tracking-tighter leading-[0.9] mb-6">
              LET'S BUILD<br/>
              <span className="text-lime-400 italic pr-4">SOMETHING</span>
            </h3>
          </div>
          <div className="flex lg:justify-end">
            <Link 
              href="/contact"
              className="group relative overflow-hidden bg-lime-400 text-black px-12 py-8 rounded-full text-2xl font-bold transition-all duration-500 hover:scale-[1.02] shadow-[0_0_40px_rgba(204,255,0,0.15)] flex items-center gap-4 w-full md:w-auto justify-between"
            >
              ...
              <div className="w-12 h-12 bg-black rounded-full flex items-center justify-center relative z-10 group-hover:bg-white transition-colors duration-300">
                <ArrowUpRight className="w-6 h-6 text-lime-400 group-hover:text-black transition-colors" />
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-20">
          <div className="lg:col-span-4">
            ...
            <div className="flex gap-4">
              {[Twitter, Github, Linkedin].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/70 hover:bg-lime-400 hover:text-black hover:border-lime-400 transition-all duration-300">
          ...
          <div className="lg:col-span-2 lg:col-start-7">
            ...
            <ul className="space-y-4">
              {footerLinks.services.map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="text-white/70 text-sm hover:text-lime-400 transition-colors flex items-center gap-2 group">
                    {link.label}
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4">
              <li>
                <a href="mailto:hello@jointwebsolutions.com" className="text-white/70 text-sm hover:text-lime-400 transition-colors flex items-center gap-2">
                  <Mail className="w-4 h-4" /> hello@jointwebsolutions.com
                </a>
              </li>
              <li>
                <a href="tel:+1234567890" className="text-white/70 text-sm hover:text-lime-400 transition-colors flex items-center gap-2">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 font-mono text-xs uppercase tracking-widest">
            <Link href="#" className="text-white/30 hover:text-lime-400 transition-colors">Privacy Policy</Link>
            <Link href="#" className="text-white/30 hover:text-lime-400 transition-colors">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
